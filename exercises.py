...
def manage_students():
    # your code here
    # Creating a list with three student names from our class
    students = ['Shae', 'David', 'Quan']
...
def combine_foods():
    # your code here
    # Creating a tuple with three food names
    foods = ('sushi', 'salad', 'pasta')

    # Starting with an empty string
    meal = ''

    # Looping to add each food to meal
    for food in foods:
        meal = meal + food
    return meal
...
def slice_foods():
    # your code here
    # Creating a tuple with three food names
    foods = ('hamburgers', 'pizza', 'tacos')
    # Getting last two foods using slice
...
def hometown_info():
    # your code here
    # Creating a dictionary with home town info
    home_town = {'city': 'New York', 'state': 'NY', 'population': 9000000}
    # Creating a message using dictionary values
...
def create_awesome_students():
    ...
    students = ['Bronte', 'Sam', 'Florentina']
...
def filter_foods_with_a():
    ...
    # Create list of foods with 'a' using list comprehension
